(function (win, resultInfoObj, radioName) {
    ...
    GesturePwd.prototype = {
        init: function () {
            ...
            if (win.devicePixelRatio) { //消除canvas锯齿
            ...
            if (!this.pwdStyle) {
                ...
                //判断每个样式是否存在
                if(!this.pwdStyle.genericStyle){
                    this.pwdStyle.genericStyle = this.defaultStyle.genericStyle;
                }
                if(!this.pwdStyle.errorStyle){
                    this.pwdStyle.errorStyle = this.defaultStyle.errorStyle;
                }
                if(!this.pwdStyle.selectStyle){
                    this.pwdStyle.selectStyle = this.defaultStyle.selectStyle;
                }
                if(!this.pwdStyle.lineStyle){
                    this.pwdStyle.lineStyle = this.defaultStyle.lineStyle;
                }
            }
            this.createPwdPanel();
            this.bindEvent();
